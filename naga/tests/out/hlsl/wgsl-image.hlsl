...
float4 texture_sample() : SV_Target0
{
    ...
    a = (_e37 + _e41);
    float4 _e43 = a;
    float4 _e46 = image_2d.SampleGrad(sampler_reg, _e1, _e1, _e1);
    a = (_e43 + _e46);
    float4 _e48 = a;
    float4 _e51 = nagaTextureSampleBaseClampToEdge(image_2d, sampler_reg, _e1);
    a = (_e48 + _e51);
    float4 _e53 = a;
    float4 _e57 = image_2d_array.Sample(sampler_reg, float3(_e1, 0u));
    a = (_e53 + _e57);
    float4 _e59 = a;
    float4 _e63 = image_2d_array.Sample(sampler_reg, float3(_e1, 0u), int2(int2(int(3), int(1))));
    a = (_e59 + _e63);
    float4 _e65 = a;
    float4 _e69 = image_2d_array.SampleLevel(sampler_reg, float3(_e1, 0u), 2.3);
    a = (_e65 + _e69);
    float4 _e71 = a;
    float4 _e75 = image_2d_array.SampleLevel(sampler_reg, float3(_e1, 0u), 2.3, int2(int2(int(3), int(1))));
    a = (_e71 + _e75);
    float4 _e77 = a;
    float4 _e82 = image_2d_array.SampleBias(sampler_reg, float3(_e1, 0u), 2.0, int2(int2(int(3), int(1))));
    a = (_e77 + _e82);
    float4 _e84 = a;
    float4 _e88 = image_2d_array.Sample(sampler_reg, float3(_e1, int(0)));
    a = (_e84 + _e88);
    float4 _e90 = a;
    float4 _e94 = image_2d_array.Sample(sampler_reg, float3(_e1, int(0)), int2(int2(int(3), int(1))));
    a = (_e90 + _e94);
    float4 _e96 = a;
    float4 _e100 = image_2d_array.SampleLevel(sampler_reg, float3(_e1, int(0)), 2.3);
    a = (_e96 + _e100);
    float4 _e102 = a;
    float4 _e106 = image_2d_array.SampleLevel(sampler_reg, float3(_e1, int(0)), 2.3, int2(int2(int(3), int(1))));
    a = (_e102 + _e106);
    float4 _e108 = a;
    float4 _e113 = image_2d_array.SampleBias(sampler_reg, float3(_e1, int(0)), 2.0, int2(int2(int(3), int(1))));
    a = (_e108 + _e113);
    float4 _e115 = a;
    float4 _e119 = image_cube_array.Sample(sampler_reg, float4(_e3, 0u));
    a = (_e115 + _e119);
    float4 _e121 = a;
    float4 _e125 = image_cube_array.SampleLevel(sampler_reg, float4(_e3, 0u), 2.3);
    a = (_e121 + _e125);
    float4 _e127 = a;
    float4 _e132 = image_cube_array.SampleBias(sampler_reg, float4(_e3, 0u), 2.0);
    a = (_e127 + _e132);
    float4 _e134 = a;
    float4 _e138 = image_cube_array.Sample(sampler_reg, float4(_e3, int(0)));
    a = (_e134 + _e138);
    float4 _e140 = a;
    float4 _e144 = image_cube_array.SampleLevel(sampler_reg, float4(_e3, int(0)), 2.3);
    a = (_e140 + _e144);
    float4 _e146 = a;
    float4 _e151 = image_cube_array.SampleBias(sampler_reg, float4(_e3, int(0)), 2.0);
    a = (_e146 + _e151);
    float4 _e153 = a;
    float4 _e156 = image_cube.SampleGrad(sampler_reg, _e3, _e3, _e3);
    a = (_e153 + _e156);
    float4 _e158 = a;
    float4 _e161 = image_3d.SampleGrad(sampler_reg, _e3, _e3, _e3);
    a = (_e158 + _e161);
    float4 _e163 = a;
    return _e163;
}
