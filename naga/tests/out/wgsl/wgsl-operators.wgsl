...
fn builtins() -> vec4<f32> {
    ...
    let m1_ = vec4<f32>(0.5f, 0.5f, 0.5f, 0.5f);
    let m2_ = vec4<f32>(0.1f, 0.1f, 0.1f, 0.1f);
    let b2_ = vec4<f32>(0.000000000000000000000000000000000000000000001f, 0.000000000000000000000000000000000000000000001f, 0.000000000000000000000000000000000000000000001f, 0.000000000000000000000000000000000000000000001f);
    let v_i32_zero = vec4<i32>(0i, 0i, 0i, 0i);
    return (((((vec4<f32>((vec4(s1_) + v_i32_zero)) + s2_) + m1_) + m2_) + vec4(0.000000000000000000000000000000000000000000001f)) + b2_);
}
