...
fn texture_sample() -> @location(0) vec4<f32> {
    ...
    a = (_e37 + _e41);
    let _e43 = a;
    let _e46 = textureSampleGrad(image_2d, sampler_reg, _e1, _e1, _e1);
    a = (_e43 + _e46);
    let _e48 = a;
    let _e51 = textureSampleBaseClampToEdge(image_2d, sampler_reg, _e1);
    a = (_e48 + _e51);
    let _e53 = a;
    let _e57 = textureSample(image_2d_array, sampler_reg, _e1, 0u);
    a = (_e53 + _e57);
    let _e59 = a;
    let _e63 = textureSample(image_2d_array, sampler_reg, _e1, 0u, vec2<i32>(3i, 1i));
    a = (_e59 + _e63);
    let _e65 = a;
    let _e69 = textureSampleLevel(image_2d_array, sampler_reg, _e1, 0u, 2.3f);
    a = (_e65 + _e69);
    let _e71 = a;
    let _e75 = textureSampleLevel(image_2d_array, sampler_reg, _e1, 0u, 2.3f, vec2<i32>(3i, 1i));
    a = (_e71 + _e75);
    let _e77 = a;
    let _e82 = textureSampleBias(image_2d_array, sampler_reg, _e1, 0u, 2f, vec2<i32>(3i, 1i));
    a = (_e77 + _e82);
    let _e84 = a;
    let _e88 = textureSample(image_2d_array, sampler_reg, _e1, 0i);
    a = (_e84 + _e88);
    let _e90 = a;
    let _e94 = textureSample(image_2d_array, sampler_reg, _e1, 0i, vec2<i32>(3i, 1i));
    a = (_e90 + _e94);
    let _e96 = a;
    let _e100 = textureSampleLevel(image_2d_array, sampler_reg, _e1, 0i, 2.3f);
    a = (_e96 + _e100);
    let _e102 = a;
    let _e106 = textureSampleLevel(image_2d_array, sampler_reg, _e1, 0i, 2.3f, vec2<i32>(3i, 1i));
    a = (_e102 + _e106);
    let _e108 = a;
    let _e113 = textureSampleBias(image_2d_array, sampler_reg, _e1, 0i, 2f, vec2<i32>(3i, 1i));
    a = (_e108 + _e113);
    let _e115 = a;
    let _e119 = textureSample(image_cube_array, sampler_reg, _e3, 0u);
    a = (_e115 + _e119);
    let _e121 = a;
    let _e125 = textureSampleLevel(image_cube_array, sampler_reg, _e3, 0u, 2.3f);
    a = (_e121 + _e125);
    let _e127 = a;
    let _e132 = textureSampleBias(image_cube_array, sampler_reg, _e3, 0u, 2f);
    a = (_e127 + _e132);
    let _e134 = a;
    let _e138 = textureSample(image_cube_array, sampler_reg, _e3, 0i);
    a = (_e134 + _e138);
    let _e140 = a;
    let _e144 = textureSampleLevel(image_cube_array, sampler_reg, _e3, 0i, 2.3f);
    a = (_e140 + _e144);
    let _e146 = a;
    let _e151 = textureSampleBias(image_cube_array, sampler_reg, _e3, 0i, 2f);
    a = (_e146 + _e151);
    let _e153 = a;
    let _e156 = textureSampleGrad(image_cube, sampler_reg, _e3, _e3, _e3);
    a = (_e153 + _e156);
    let _e158 = a;
    let _e161 = textureSampleGrad(image_3d, sampler_reg, _e3, _e3, _e3);
    a = (_e158 + _e161);
    let _e163 = a;
    return _e163;
}
